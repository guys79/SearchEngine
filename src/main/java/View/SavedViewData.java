...
public class SavedViewData {
    ...
    public SavedViewData(Searcher searcher,boolean isStemButtonDisabled,boolean isStem,boolean isSemantic,String postingPath,String quriesPath,HashSet<String>quries)
    {
